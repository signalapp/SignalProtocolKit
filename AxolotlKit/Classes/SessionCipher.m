...
- (id<CipherMessage>)throws_encryptMessage:(NSData *)paddedMessage protocolContext:(nullable id<ProtocolContext>)protocolContext
{
...
- (NSData *)throws_decrypt:(id<CipherMessage>)whisperMessage protocolContext:(nullable id<ProtocolContext>)protocolContext
{
...
- (NSData *)throws_decryptWhisperMessage:(WhisperMessage *)whisperMessage protocolContext:(nullable id<ProtocolContext>)protocolContext
{
    OWSAssert(whisperMessage);
...
- (int)throws_remoteRegistrationId:(nullable id<ProtocolContext>)protocolContext
{
...
- (int)throws_sessionVersion:(nullable id<ProtocolContext>)protocolContext
{
    SessionRecord *_Nullable record =
        [self.sessionStore loadSession:self.recipientId deviceId:_deviceId protocolContext:protocolContext];
